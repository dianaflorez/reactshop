...
import { ShoppingCartProvider, initialLocalStorage, ShoppingCartContext } from '../../Context'
...
const AppRoutes = () => {
  ...
  console.log('hasUserAnAccount && !isUserSignOut---->',hasUserAnAccount, isUserSignOut);
  ...
  let routes = useRoutes([
    ...
    { path: '/othes', element: hasUserAnAccount && !isUserSignOut ? <Home /> : <Navigate replace to='/sign-in' /> },
